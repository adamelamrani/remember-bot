...
export default class MessagesRepository {
  ...
  async getAllMessagesFromUser(username: string, chatid: number): Promise<Message[] | MessagesNotFoundError> {
  ...
  async getLastMessageFromUser(username: string, chatid: number): Promise<Message | MessagesNotFoundError> {
